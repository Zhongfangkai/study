...
(function (window) {
    ...
    /*调用拨打打电话功能*/
    a.callPhone = function (number) {
        api.call({type: 'tel_prompt', number: !isNaN(number) ? number : '10086'});
    }
 ...
 * @returns {*|IScroll}
 */
function initNavScroll(id, callback) {
    return new IScroll(id, {
        ...
        callBack: function (self, target) {
            ...
            var eLis = $api.domAll('#iscroll .con-item'), index = 0;
